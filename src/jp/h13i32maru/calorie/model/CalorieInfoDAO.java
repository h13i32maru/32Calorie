...
public class CalorieInfoDAO {
	...
	private static final int[] mColorArray = {
			Color.argb(0xff, 0xff, 0x33, 0x33),
			Color.argb(0xff, 0x33, 0xff, 0x33),
			Color.argb(0xff, 0x33, 0x33, 0xff),
			Color.argb(0xff, 0xaa, 0xaa, 0x33),
			Color.argb(0xff, 0xcc, 0x33, 0xcc)
	};
