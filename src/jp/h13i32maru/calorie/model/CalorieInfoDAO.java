...
public class CalorieInfoDAO {
	...
	private static final int[] mColorArray = {
			Color.argb(0xff, 0xff, 0x55, 0x55),
			Color.argb(0xff, 0x55, 0xff, 0x55),
			Color.argb(0xff, 0x55, 0x55, 0xff),
			Color.argb(0xff, 0xbb, 0xbb, 0x55),
			Color.argb(0xff, 0xdd, 0x55, 0xdd)
	};
